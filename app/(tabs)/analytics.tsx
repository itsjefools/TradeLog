...
function makeStyles(c: ThemeColors) {
  return StyleSheet.create({
    ...
    kpiLabel: { fontSize: 11, color: c.textSecondary, marginBottom: 6, fontWeight: '600', letterSpacing: 0.3 },
    kpiValue: { fontSize: 18, fontWeight: '800', color: c.textPrimary, fontVariant: ['tabular-nums'], letterSpacing: -0.3 },
    primaryKpi: {
      paddingTop: 8,
      paddingBottom: 24,
      borderBottomWidth: StyleSheet.hairlineWidth,
